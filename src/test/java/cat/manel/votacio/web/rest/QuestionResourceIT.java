...
public class QuestionResourceIT {
    ...
    private static final Section DEFAULT_SECTION = new Section(1L);
    private static final Section UPDATED_SECTION = new Section(2L);

    private static final QuestionStatus DEFAULT_STATUS = new QuestionStatus(1L);
    private static final QuestionStatus UPDATED_STATUS = new QuestionStatus(2L);
    ...
    @Test
    @Transactional
    public void checkSectionIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
    ...
    public void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sectionId").value(hasItem(DEFAULT_SECTION.getId().intValue())))
    ...
    public void getQuestion() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions/{id}", question.getId()))
            ...
            .andExpect(jsonPath("$.sectionId").value(DEFAULT_SECTION.getId().intValue()))
