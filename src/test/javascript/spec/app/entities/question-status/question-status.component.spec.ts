...
import { QuestionStatusComponent } from 'app/entities/question-status/question-status.component';
...
describe('Component Tests', () => {
  describe('QuestionStatus Management Component', () => {
    let comp: QuestionStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QuestionStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.questionStatuses && comp.questionStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
