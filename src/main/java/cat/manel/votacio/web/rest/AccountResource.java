...
import cat.manel.votacio.domain.PersistentToken;
import cat.manel.votacio.domain.User;
import cat.manel.votacio.repository.PersistentTokenRepository;
import cat.manel.votacio.repository.UserRepository;
import cat.manel.votacio.security.SecurityUtils;
import cat.manel.votacio.service.EmailAlreadyUsedException;
import cat.manel.votacio.service.InvalidPasswordException;
import cat.manel.votacio.service.MailService;
import cat.manel.votacio.service.UserService;
import cat.manel.votacio.service.dto.PasswordChangeDTO;
import cat.manel.votacio.service.dto.UserDTO;
import cat.manel.votacio.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        userService.updateUser(userDTO.getFirstName(), userDTO.getSurname1(), userDTO.getSurname2(), userDTO.getNifnie(), userDTO.getEmail(),
