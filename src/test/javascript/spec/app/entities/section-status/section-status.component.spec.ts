...
import { SectionStatusComponent } from 'app/entities/section-status/section-status.component';
...
describe('Component Tests', () => {
  describe('SectionStatus Management Component', () => {
    let comp: SectionStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SectionStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sectionStatuses && comp.sectionStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
