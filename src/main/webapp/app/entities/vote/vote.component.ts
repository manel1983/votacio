...
export class VoteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.voteService
      ...
      .subscribe(
        (res: HttpResponse<IVote[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInVotes(): void {
    this.eventSubscriber = this.eventManager.subscribe('voteListModification', () => this.loadPage());
  }
