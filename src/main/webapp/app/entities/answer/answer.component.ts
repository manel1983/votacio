...
export class AnswerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.answerService
      ...
      .subscribe(
        (res: HttpResponse<IAnswer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAnswers(): void {
    this.eventSubscriber = this.eventManager.subscribe('answerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAnswer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
