...
import cat.manel.votacio.config.audit.AuditEventConverter;
import cat.manel.votacio.domain.PersistentAuditEvent;
...
import static cat.manel.votacio.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
